...
{
  /*
   * This line of code, generated by ChatGPT was incorrect. After I
   * asked about the error it gave me the corrected code that lives
   * right below. I'll leave the incorrect code here to serve as a
   * reminder of the code generation process.
   * gpioChip = gpiod_chip_open_by_name(chipName.c_str());
   */

  gpioChip = gpiod_chip_open(chipName.c_str());
...
/* Another error from ChatGPT the 2nd argurment should have been a bool.
 * I will not keep the old definition since that will just make reading the
