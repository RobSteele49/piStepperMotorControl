...
3. **Enable I2C and SPI** (required for WaveShare HAT)
...
1. Measure actual rotation: Run `[K]` (Keep Current) at a known position
2. Check `STEPS_PER_KNOB_REV` - currently calibrated for 5 turns → 6.75 turns
3. Recalibrate formula: `STEPS_PER_KNOB_REV = (measured_steps / expected_steps) * current_value`
...
1. Check the [Troubleshooting](https://github.com/copilot/c/64036255-bc0f-490d-a8bd-021a3a2d4f26#troubleshooting) section
2. Review `docs/ObsidianDocuments/` for detailed notes
